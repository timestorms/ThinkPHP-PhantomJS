...
abstract class Driver {
    ...
    public function query($str,$fetchSql=false) {
        ...
        log_message('DB query sql:'.$str,LOG_DEBUG);
        ...
        if(false === $this->PDOStatement){
            ...
            log_message('DB query error_1!info:'.json_encode($this->PDOStatement->errorInfo()),LOG_EMERG);
        ...
        try{
            ...
            if ( false === $result ) {
                ...
                log_message('DB query error_2!info:'.json_encode($this->PDOStatement->errorInfo()),LOG_EMERG);
                $this->error();
                return false;
            } else {
    ...
    public function execute($str,$fetchSql=false) {
        ...
        if(false === $this->PDOStatement) {
            ...
            log_message('DB execute error_1!info:'.json_encode($this->PDOStatement->errorInfo()),LOG_EMERG); 
        ...
        log_message('DB execute sql:'.$str,LOG_DEBUG);
        try{
            $result =   $this->PDOStatement->execute();
            // 调试结束
            $this->debug(false);
            if ( false === $result) {
                log_message('DB execute error_2!info:'.json_encode($this->PDOStatement->errorInfo()),LOG_EMERG);
                $this->error();
                return false;
            } else {
