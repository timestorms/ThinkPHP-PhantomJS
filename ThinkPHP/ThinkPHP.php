...
defined('STATIC_PATH')    or define('STATIC_PATH',      APP_PATH.'Home/static/'); // 应用静态目录
defined('JS_PATH')    or define('JS_PATH',      STATIC_PATH.'js/'); // 应用静态目录
...
defined('RENDER_HTML_PATH')    or define('RENDER_HTML_PATH',      DATA_PATH.'html_data/'); // 渲染过的html数据目录
...
if(!defined('APP_PATH_LOG')){
    define('APP_PATH_LOG', LOG_PATH.'crawle/');
}
